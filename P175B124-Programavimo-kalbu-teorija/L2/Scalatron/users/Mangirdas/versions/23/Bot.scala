...
object ControlFunction
{
    ...
    def forMaster(bot: Bot) {
        ...
        bot.log("direction value 0 - " + directionValue(0))
        bot.log("direction value 1 - " + directionValue(1))
        bot.log("direction value 2 - " + directionValue(2))
        bot.log("direction value 3 - " + directionValue(3))
        bot.log("direction value 4 - " + directionValue(4))
        bot.log("direction value 5 - " + directionValue(5))
        bot.log("direction value 6 - " + directionValue(6))
        bot.log("direction value 7 - " + directionValue(7))
