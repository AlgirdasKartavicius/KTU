...
object ControlFunction
{
    ...
    def forMaster(bot: Bot) {
        val (directionValue, nearestEnemyMaster, nearestEnemySlave, nearestBeastPlant) = analyzeViewAsMaster(bot.view)
        ...
        if (nearestBeastPlant != -1) bfs.findPath(480, nearestBeastPlant)
    ...
    def analyzeViewAsMaster(view: View) = {
        ...
        (directionValue, nearestEnemyMaster, nearestEnemySlave, nearestBeastPlant)
    }
