	...
	<?php	} else {
				...
				if(sizeof($contractData) > 0) { ?>
					...
					<table class="reportTable">
						...
						<tr class="aggregate">
							<td class="label" colspan="2">Bendra prekių suma: </td>
							<td class="border"><?php echo $contractsObj->getPrekesSum($data['fk_SportoSakaid']); ?> &euro;</td>
						</tr>
						
						<tr class="aggregate">
							<td class="label" colspan="2">Brangiausios prekės kaina: </td>
							<td class="border"><?php echo $contractsObj->getMaxPreke($data['fk_SportoSakaid']); ?> &euro;</td>
						</tr>
