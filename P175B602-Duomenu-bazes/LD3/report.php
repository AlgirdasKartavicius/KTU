...
<html>
	...
	<body class="report">
		<div id="body">
			<?php
				switch($id) {
					case 1: include "controls/SaskaituAtaskaita.php"; break;
					case 2: include "controls/PrekiuKainosAtaskaita.php"; break;
					case 3: include "controls/SportoSakosPrekiuAtaskaita.php"; break;
					default: break;
				}
			?>
		</div>
